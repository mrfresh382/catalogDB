...
Item1 = Item(user_id=User1.id, name="Bear Spray",
             description="We don't allow firearms at the park. \
             Use this to repel dangerous \
...
Item3 = Item(user_id=User1.id, name="Signal Mirror",
             description="Use this to signal airplanes or other hikers if \
             you get lost.\
             The park is a no-fly zone for airplanes. Do people still use \
             these?",
...
Item4 = Item(user_id=User2.id, name="Hiking Stick",
             description="Made from dried up ocotillo plant. \
             Might support your \
...
Item6 = Item(user_id=User2.id, name="Orange Jumpsuit",
             description="Subsidized by the government for hikers that \
             get lost. All sizes available. Visible up to 7 miles. \
             We are legally required to sell this.", price="$19.99",
             category=category2)
